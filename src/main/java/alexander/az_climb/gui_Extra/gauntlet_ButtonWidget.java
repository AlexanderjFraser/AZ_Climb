...
public class gauntlet_ButtonWidget extends ButtonWidget {
    private static final Identifier PK_BUTTON = new Identifier(MOD_ID, "textures/gui/gauntlet_button.png");
    private static final int BORDER_COLOR = 0xFF000000;
    public gauntlet_ButtonWidget(int x, int y, int width, int height, Text message, PressAction onPress) {
